...
//! (`crate::capture::broker::shared_client`) rather than calling
...
//! `crate::capture::broker`) — it only calls it, exactly as `tools::window`
...
use crate::capture::broker::shared_client;
